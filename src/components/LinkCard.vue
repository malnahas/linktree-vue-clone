  ...
  >
    ...
    <div class="min-w-0 flex-1">
      ...
      <p class="truncate text-sm text-gray-400">
        ab sadjnboa sdjnioa asjdnuiw hfe sjd whjsid ujwjdi sjdni asudnbqon sadoqwodnas do.
      </p>
    </div>

    <!-- Hover Glow Effect-->
    <div
      class="bgb-linear-to-r transition-opacity-100 absolute inset-0 rounded-xl from-green-500/0 via-green-500/10 to-green-500/0 opacity-0"
    />
  </a>
</template>
